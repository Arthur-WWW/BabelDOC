...
from .builder import ParagraphBuilder
...
def run_hybrid_pipeline(
    ...
    try:
        docs, mediabox_data, temp_pdf_path = _parse_pdf_to_il(translation_config)
        if not docs.page:
        ...
        ParagraphBuilder(translation_config).populate_document(docs, blocks)
...
def _parse_pdf_to_il(
    translation_config: TranslationConfig,
) -> Tuple[il_version_1.Document, dict, str]:
    ...
    return document, mediabox_data, str(temp_pdf_path)
